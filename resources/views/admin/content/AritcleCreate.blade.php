                    ...
                    <div class="ibox-content">
                      ...
                      <div class="form-group">
                        <label class="col-sm-1 control-label">发布时间：</label>
                         <div class="input-group col-sm-4">
                          <input class="layui-input form-control" required name="time" placeholder="YYYY-MM-DD" onclick="layui.laydate({elem: this, istime: true, format: 'YYYY-MM-DD'})">
                         </div>
                        </div>
                                 <div class="form-group">
                                     <label class="col-sm-1 control-label">点击量：</label>
                                     <div class="input-group col-sm-1">
                                         <input id="click" type="text" value="99" class="form-control" name="click"
                                                aria-required="true">
                                     </div>
                                 </div>
                            <div class="form-group">
